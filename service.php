...
else
{
          ...
          <table width="563" border="0">
			  ...
			  <tr>
			    ...
			    <td><input name="contactno" type="text" id="contactno"  onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?php echo  $row[contactno1]; ?>" size="35" readonly="readonly"/></td>
		      </tr>
			  <tr>
